  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-36 right-6 md:bottom-8 md:right-8 z-50 w-14 h-14 bg-[#050505] border border-[#a855f7]/50 rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(168,85,247,0.2)] hover:scale-105 transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#a855f7]"
        whileHover={{
          ...
          >
            ...
            <div className="p-4 border-b border-[#a855f7]/20 flex justify-between items-center bg-[#a855f7]/5">
              ...
              <button
                ...
                className="text-gray-500 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#a855f7] rounded-sm p-1"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="p-4 border-t border-[#1a1a1a] flex flex-col items-center justify-center bg-black/50">
              ...
              <button
                ...
                className={`w-12 h-12 rounded-full flex items-center justify-center transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#a855f7] ${
                  isListening
