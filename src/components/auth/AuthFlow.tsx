  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <div>
          <label htmlFor="email" className="text-[10px] font-mono text-gray-400 uppercase tracking-widest block mb-1.5 ml-1 cursor-pointer hover:text-gray-300 transition-colors">Operator ID / Email</label>
          <div className="relative group">
            ...
            <input id="email" type="text" className="w-full bg-black/40 border border-[#1a1a1a] rounded-xl px-9 py-3 text-sm text-white focus:outline-none focus:border-[#0ea5e9]/50 transition-colors font-mono focus:bg-black/60" placeholder="sys_op@tradex.inc" defaultValue="alex.strata" />
          </div>
        </div>

        <div>
           <div className="flex justify-between items-center mb-1.5 px-1">
             <label htmlFor="password" className="text-[10px] font-mono text-gray-400 uppercase tracking-widest block cursor-pointer hover:text-gray-300 transition-colors">Passphrase</label>
          ...
          <div className="relative group">
            ...
            <input id="password" type={showPassword ? "text" : "password"} className="w-full bg-black/40 border border-[#1a1a1a] rounded-xl px-9 py-3 text-sm text-white focus:outline-none focus:border-[#0ea5e9]/50 transition-colors font-mono focus:bg-black/60" placeholder="••••••••••••••••" defaultValue="tradex2026!#" />
            <button
              type="button"
              onClick={() => setShowPassword(!showPassword)}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0ea5e9]"
      ...
      <div className="flex gap-3 mt-4">
        ...
        <button
          type="button"
          onClick={onNext}
          className="w-12 h-12 border border-[#1a1a1a] bg-black/40 hover:bg-black/80 rounded-xl flex items-center justify-center text-[#0ea5e9] hover:border-[#0ea5e9]/50 transition-all flex-shrink-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0ea5e9]"
