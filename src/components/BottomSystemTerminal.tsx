      ...
      <div className="flex items-center justify-between px-4 py-1.5 border-b border-[#111] bg-[#050505]">
         <div className="flex items-center gap-4">
           ...
           <div className="flex gap-3 text-[9px] font-mono">
             <span className="text-white border-b border-[#00f0ff] pb-[1px] cursor-pointer">Logs</span>
             <span className="text-gray-600 hover:text-white cursor-pointer transition-colors pb-[1px]">Network</span>
             <span className="text-gray-600 hover:text-white cursor-pointer transition-colors pb-[1px]">Risk Engine</span>
           </div>
         </div>
         <div className="flex items-center gap-3 text-[9px] font-mono text-gray-500">
           ...
           <button
             ...
             className="hover:text-white transition-colors ml-2 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 rounded-sm p-1"
           >
         ...
         {logs.map((log, i) => (
           <div key={i} className="flex items-start gap-3">
             ...
             <span className={
               ...
               log.startsWith('NETWORK:') ? 'text-gray-400' :
               'text-[#00f0ff]'
             }>{log}</span>
           </div>
         ))}
